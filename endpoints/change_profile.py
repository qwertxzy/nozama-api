...
@change_profile.route('/change_profile/vendor/<session_id>', methods=['POST'])
def handle_vendor(session_id):
    # session_ids are 16 characters long
    if (len(session_id) > 16):
        return '', status.HTTP_400_BAD_REQUEST
    ...
    return_status = cursor.callproc('change_vendor', args=[session_id, name, description, 0])
